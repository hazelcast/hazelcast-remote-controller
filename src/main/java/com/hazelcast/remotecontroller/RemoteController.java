...
@javax.annotation.Generated(value = "Autogenerated by Thrift Compiler (0.15.0)", date = "2022-04-25")
...
;
  ...
  public static class scaleUpDownHazelcastCloudStandardCluster_args implements org.apache.thrift.TBase<scaleUpDownHazelcastCloudStandardCluster_args, scaleUpDownHazelcastCloudStandardCluster_args._Fields>, java.io.Serializable, Cloneable, Comparable<scaleUpDownHazelcastCloudStandardCluster_args>   {
    ...
    public int compareTo(scaleUpDownHazelcastCloudStandardCluster_args other) {
      ...
      lastComparison = java.lang.Boolean.compare(isSetScaleNumber(), other.isSetScaleNumber());
      if (lastComparison != 0) {
        return lastComparison;
      }
      if (isSetScaleNumber()) {
