...
RemoteController_ping_args = function(args) {
};
...
RemoteController_ping_result = function(args) {
  this.success = null;
  if (args) {
...
RemoteController_clean_args = function(args) {
};
...
RemoteController_clean_result = function(args) {
  this.success = null;
  if (args) {
    if (args.success !== undefined && args.success !== null) {
      this.success = args.success;
...
RemoteController_exit_args = function(args) {
};
...
RemoteController_exit_result = function(args) {
  this.success = null;
  if (args) {
    if (args.success !== undefined && args.success !== null) {
      this.success = args.success;
...
RemoteController_createCluster_args = function(args) {
  this.hzVersion = null;
  this.xmlconfig = null;
  if (args) {
...
RemoteController_createCluster_result = function(args) {
  this.success = null;
...
RemoteController_startMember_args = function(args) {
  this.clusterId = null;
  this.delay = null;
  if (args) {
...
RemoteController_startMember_args.prototype.write = function(output) {
  ...
  if (this.delay !== null && this.delay !== undefined) {
    output.writeFieldBegin('delay', Thrift.Type.I32, 2);
...
RemoteController_startMember_result = function(args) {
  this.success = null;
  this.serverException = null;
  if (args instanceof ttypes.ServerException) {
    this.serverException = args;
...
RemoteController_shutdownMember_args = function(args) {
  this.clusterId = null;
  this.memberId = null;
  this.delay = null;
  if (args) {
...
RemoteController_shutdownMember_args.prototype.write = function(output) {
  ...
  if (this.delay !== null && this.delay !== undefined) {
    output.writeFieldBegin('delay', Thrift.Type.I32, 3);
    output.writeI32(this.delay);
    output.writeFieldEnd();
  }
  output.writeFieldStop();
...
RemoteController_shutdownMember_result = function(args) {
  this.success = null;
  if (args) {
    if (args.success !== undefined && args.success !== null) {
      this.success = args.success;
...
RemoteController_terminateMember_args = function(args) {
  this.clusterId = null;
  this.memberId = null;
  this.delay = null;
  if (args) {
...
RemoteController_terminateMember_result = function(args) {
  this.success = null;
  if (args) {
    if (args.success !== undefined && args.success !== null) {
      this.success = args.success;
...
RemoteController_shutdownCluster_result = function(args) {
  this.success = null;
  if (args) {
    if (args.success !== undefined && args.success !== null) {
      this.success = args.success;
...
RemoteController_terminateCluster_args = function(args) {
  this.clusterId = null;
  this.delay = null;
  if (args) {
    if (args.clusterId !== undefined && args.clusterId !== null) {
...
RemoteController_terminateCluster_result = function(args) {
  this.success = null;
  if (args) {
    if (args.success !== undefined && args.success !== null) {
      this.success = args.success;
...
RemoteController_splitMemberFromCluster_args = function(args) {
  this.memberId = null;
  this.delay = null;
  if (args) {
    if (args.memberId !== undefined && args.memberId !== null) {
...
RemoteController_splitMemberFromCluster_result = function(args) {
  this.success = null;
  if (args) {
    if (args.success !== undefined && args.success !== null) {
      this.success = new ttypes.Cluster(args.success);
...
RemoteController_mergeMemberToCluster_args = function(args) {
  this.clusterId = null;
  this.memberId = null;
  this.delay = null;
  if (args) {
...
RemoteController_mergeMemberToCluster_result = function(args) {
  this.success = null;
  if (args) {
    if (args.success !== undefined && args.success !== null) {
      this.success = new ttypes.Cluster(args.success);
...
RemoteController_executeOnController_args = function(args) {
  this.clusterId = null;
  this.script = null;
  this.lang = null;
  if (args) {
...
RemoteController_executeOnController_result = function(args) {
  this.success = null;
  if (args) {
    if (args.success !== undefined && args.success !== null) {
      this.success = args.success;
...
RemoteControllerClient = exports.Client = function(output, pClass) {
    this.output = output;
    this.pClass = pClass;
    this._seqid = 0;
    this._reqs = {};
...
RemoteControllerClient.prototype.startMember = function(clusterId, delay, callback) {
  this._seqid = this.new_seqid();
  if (callback === undefined) {
    var _defer = Q.defer();
    this._reqs[this.seqid()] = function(error, result) {
    ...
    this.send_startMember(clusterId, delay);
    return _defer.promise;
  } else {
    this._reqs[this.seqid()] = callback;
    this.send_startMember(clusterId, delay);
...
RemoteControllerClient.prototype.send_startMember = function(clusterId, delay) {
  var output = new this.pClass(this.output);
...
RemoteControllerClient.prototype.shutdownMember = function(clusterId, memberId, delay, callback) {
  this._seqid = this.new_seqid();
  if (callback === undefined) {
    var _defer = Q.defer();
    this._reqs[this.seqid()] = function(error, result) {
    ...
    this.send_shutdownMember(clusterId, memberId, delay);
    return _defer.promise;
  } else {
    this._reqs[this.seqid()] = callback;
    this.send_shutdownMember(clusterId, memberId, delay);
...
RemoteControllerClient.prototype.send_shutdownMember = function(clusterId, memberId, delay) {
  var output = new this.pClass(this.output);
...
RemoteControllerClient.prototype.terminateMember = function(clusterId, memberId, delay, callback) {
  this._seqid = this.new_seqid();
  if (callback === undefined) {
    var _defer = Q.defer();
    this._reqs[this.seqid()] = function(error, result) {
    ...
    this.send_terminateMember(clusterId, memberId, delay);
    return _defer.promise;
  } else {
    this._reqs[this.seqid()] = callback;
    this.send_terminateMember(clusterId, memberId, delay);
...
RemoteControllerClient.prototype.send_terminateMember = function(clusterId, memberId, delay) {
  var output = new this.pClass(this.output);
...
RemoteControllerClient.prototype.shutdownCluster = function(clusterId, delay, callback) {
  this._seqid = this.new_seqid();
  if (callback === undefined) {
    var _defer = Q.defer();
    this._reqs[this.seqid()] = function(error, result) {
    ...
    this.send_shutdownCluster(clusterId, delay);
    return _defer.promise;
  } else {
    this._reqs[this.seqid()] = callback;
    this.send_shutdownCluster(clusterId, delay);
...
RemoteControllerClient.prototype.send_shutdownCluster = function(clusterId, delay) {
  var output = new this.pClass(this.output);
...
RemoteControllerClient.prototype.terminateCluster = function(clusterId, delay, callback) {
  this._seqid = this.new_seqid();
  if (callback === undefined) {
    var _defer = Q.defer();
    this._reqs[this.seqid()] = function(error, result) {
    ...
    this.send_terminateCluster(clusterId, delay);
    return _defer.promise;
  } else {
    this._reqs[this.seqid()] = callback;
    this.send_terminateCluster(clusterId, delay);
...
RemoteControllerClient.prototype.send_terminateCluster = function(clusterId, delay) {
  var output = new this.pClass(this.output);
...
RemoteControllerClient.prototype.splitMemberFromCluster = function(memberId, delay, callback) {
  this._seqid = this.new_seqid();
  if (callback === undefined) {
    var _defer = Q.defer();
    this._reqs[this.seqid()] = function(error, result) {
    ...
    this.send_splitMemberFromCluster(memberId, delay);
    return _defer.promise;
  } else {
    this._reqs[this.seqid()] = callback;
    this.send_splitMemberFromCluster(memberId, delay);
...
RemoteControllerClient.prototype.send_splitMemberFromCluster = function(memberId, delay) {
  var output = new this.pClass(this.output);
...
RemoteControllerClient.prototype.mergeMemberToCluster = function(clusterId, memberId, delay, callback) {
  this._seqid = this.new_seqid();
  if (callback === undefined) {
    var _defer = Q.defer();
    this._reqs[this.seqid()] = function(error, result) {
    ...
    this.send_mergeMemberToCluster(clusterId, memberId, delay);
    return _defer.promise;
  } else {
    this._reqs[this.seqid()] = callback;
    this.send_mergeMemberToCluster(clusterId, memberId, delay);
...
RemoteControllerClient.prototype.send_mergeMemberToCluster = function(clusterId, memberId, delay) {
  var output = new this.pClass(this.output);
...
RemoteControllerProcessor = exports.Processor = function(handler) {
  ...
  if (this._handler.ping.length === 0) {
    Q.fcall(this._handler.ping)
      .then(function(result) {
        var result = new RemoteController_ping_result({success: result});
    ...
    this._handler.ping(function (err, result) {
      if (err == null) {
        var result = new RemoteController_ping_result((err != null ? err : {success: result}));
        output.writeMessageBegin("ping", Thrift.MessageType.REPLY, seqid);
      } else {
        var result = new Thrift.TApplicationException(Thrift.TApplicationExceptionType.UNKNOWN, err.message);
        output.writeMessageBegin("ping", Thrift.MessageType.EXCEPTION, seqid);
...
RemoteControllerProcessor.prototype.process_clean = function(seqid, input, output) {
  ...
  if (this._handler.clean.length === 0) {
    Q.fcall(this._handler.clean)
      .then(function(result) {
        var result = new RemoteController_clean_result({success: result});
    ...
    this._handler.clean(function (err, result) {
      if (err == null) {
        var result = new RemoteController_clean_result((err != null ? err : {success: result}));
        output.writeMessageBegin("clean", Thrift.MessageType.REPLY, seqid);
      } else {
        var result = new Thrift.TApplicationException(Thrift.TApplicationExceptionType.UNKNOWN, err.message);
        output.writeMessageBegin("clean", Thrift.MessageType.EXCEPTION, seqid);
...
RemoteControllerProcessor.prototype.process_exit = function(seqid, input, output) {
  ...
  if (this._handler.exit.length === 0) {
    Q.fcall(this._handler.exit)
      .then(function(result) {
        var result = new RemoteController_exit_result({success: result});
    ...
    this._handler.exit(function (err, result) {
      if (err == null) {
        var result = new RemoteController_exit_result((err != null ? err : {success: result}));
        output.writeMessageBegin("exit", Thrift.MessageType.REPLY, seqid);
      } else {
        var result = new Thrift.TApplicationException(Thrift.TApplicationExceptionType.UNKNOWN, err.message);
        output.writeMessageBegin("exit", Thrift.MessageType.EXCEPTION, seqid);
...
RemoteControllerProcessor.prototype.process_createCluster = function(seqid, input, output) {
  ...
  if (this._handler.createCluster.length === 2) {
    Q.fcall(this._handler.createCluster, args.hzVersion, args.xmlconfig)
      .then(function(result) {
        var result = new RemoteController_createCluster_result({success: result});
        ...
        if (err instanceof ttypes.ServerException) {
          var result = new RemoteController_createCluster_result(err);
          output.writeMessageBegin("createCluster", Thrift.MessageType.REPLY, seqid);
        } else {
          var result = new Thrift.TApplicationException(Thrift.TApplicationExceptionType.UNKNOWN, err.message);
    ...
    this._handler.createCluster(args.hzVersion, args.xmlconfig, function (err, result) {
      if (err == null || err instanceof ttypes.ServerException) {
        var result = new RemoteController_createCluster_result((err != null ? err : {success: result}));
        output.writeMessageBegin("createCluster", Thrift.MessageType.REPLY, seqid);
      } else {
        var result = new Thrift.TApplicationException(Thrift.TApplicationExceptionType.UNKNOWN, err.message);
        output.writeMessageBegin("createCluster", Thrift.MessageType.EXCEPTION, seqid);
...
RemoteControllerProcessor.prototype.process_startMember = function(seqid, input, output) {
  ...
  args.read(input);
  input.readMessageEnd();
  if (this._handler.startMember.length === 2) {
    Q.fcall(this._handler.startMember, args.clusterId, args.delay)
      .then(function(result) {
        var result = new RemoteController_startMember_result({success: result});
        ...
        if (err instanceof ttypes.ServerException) {
          var result = new RemoteController_startMember_result(err);
          output.writeMessageBegin("startMember", Thrift.MessageType.REPLY, seqid);
        } else {
          var result = new Thrift.TApplicationException(Thrift.TApplicationExceptionType.UNKNOWN, err.message);
    ...
    this._handler.startMember(args.clusterId, args.delay, function (err, result) {
      if (err == null || err instanceof ttypes.ServerException) {
        var result = new RemoteController_startMember_result((err != null ? err : {success: result}));
        output.writeMessageBegin("startMember", Thrift.MessageType.REPLY, seqid);
      } else {
        var result = new Thrift.TApplicationException(Thrift.TApplicationExceptionType.UNKNOWN, err.message);
        output.writeMessageBegin("startMember", Thrift.MessageType.EXCEPTION, seqid);
...
RemoteControllerProcessor.prototype.process_shutdownMember = function(seqid, input, output) {
  ...
  args.read(input);
  input.readMessageEnd();
  if (this._handler.shutdownMember.length === 3) {
    Q.fcall(this._handler.shutdownMember, args.clusterId, args.memberId, args.delay)
      .then(function(result) {
        var result = new RemoteController_shutdownMember_result({success: result});
    ...
    this._handler.shutdownMember(args.clusterId, args.memberId, args.delay, function (err, result) {
      if (err == null) {
        var result = new RemoteController_shutdownMember_result((err != null ? err : {success: result}));
        output.writeMessageBegin("shutdownMember", Thrift.MessageType.REPLY, seqid);
      } else {
        var result = new Thrift.TApplicationException(Thrift.TApplicationExceptionType.UNKNOWN, err.message);
        output.writeMessageBegin("shutdownMember", Thrift.MessageType.EXCEPTION, seqid);
...
RemoteControllerProcessor.prototype.process_terminateMember = function(seqid, input, output) {
  ...
  args.read(input);
  input.readMessageEnd();
  if (this._handler.terminateMember.length === 3) {
    Q.fcall(this._handler.terminateMember, args.clusterId, args.memberId, args.delay)
      .then(function(result) {
        var result = new RemoteController_terminateMember_result({success: result});
    ...
    this._handler.terminateMember(args.clusterId, args.memberId, args.delay, function (err, result) {
      if (err == null) {
        var result = new RemoteController_terminateMember_result((err != null ? err : {success: result}));
        output.writeMessageBegin("terminateMember", Thrift.MessageType.REPLY, seqid);
      } else {
        var result = new Thrift.TApplicationException(Thrift.TApplicationExceptionType.UNKNOWN, err.message);
        output.writeMessageBegin("terminateMember", Thrift.MessageType.EXCEPTION, seqid);
...
RemoteControllerProcessor.prototype.process_shutdownCluster = function(seqid, input, output) {
  ...
  args.read(input);
  input.readMessageEnd();
  if (this._handler.shutdownCluster.length === 2) {
    Q.fcall(this._handler.shutdownCluster, args.clusterId, args.delay)
      .then(function(result) {
        var result = new RemoteController_shutdownCluster_result({success: result});
    ...
    this._handler.shutdownCluster(args.clusterId, args.delay, function (err, result) {
      if (err == null) {
        var result = new RemoteController_shutdownCluster_result((err != null ? err : {success: result}));
        output.writeMessageBegin("shutdownCluster", Thrift.MessageType.REPLY, seqid);
      } else {
        var result = new Thrift.TApplicationException(Thrift.TApplicationExceptionType.UNKNOWN, err.message);
        output.writeMessageBegin("shutdownCluster", Thrift.MessageType.EXCEPTION, seqid);
...
RemoteControllerProcessor.prototype.process_terminateCluster = function(seqid, input, output) {
  ...
  args.read(input);
  input.readMessageEnd();
  if (this._handler.terminateCluster.length === 2) {
    Q.fcall(this._handler.terminateCluster, args.clusterId, args.delay)
      .then(function(result) {
        var result = new RemoteController_terminateCluster_result({success: result});
    ...
    this._handler.terminateCluster(args.clusterId, args.delay, function (err, result) {
      if (err == null) {
        var result = new RemoteController_terminateCluster_result((err != null ? err : {success: result}));
        output.writeMessageBegin("terminateCluster", Thrift.MessageType.REPLY, seqid);
      } else {
        var result = new Thrift.TApplicationException(Thrift.TApplicationExceptionType.UNKNOWN, err.message);
        output.writeMessageBegin("terminateCluster", Thrift.MessageType.EXCEPTION, seqid);
...
RemoteControllerProcessor.prototype.process_splitMemberFromCluster = function(seqid, input, output) {
  ...
  args.read(input);
  input.readMessageEnd();
  if (this._handler.splitMemberFromCluster.length === 2) {
    Q.fcall(this._handler.splitMemberFromCluster, args.memberId, args.delay)
      .then(function(result) {
        var result = new RemoteController_splitMemberFromCluster_result({success: result});
    ...
    this._handler.splitMemberFromCluster(args.memberId, args.delay, function (err, result) {
      if (err == null) {
        var result = new RemoteController_splitMemberFromCluster_result((err != null ? err : {success: result}));
        output.writeMessageBegin("splitMemberFromCluster", Thrift.MessageType.REPLY, seqid);
      } else {
        var result = new Thrift.TApplicationException(Thrift.TApplicationExceptionType.UNKNOWN, err.message);
        output.writeMessageBegin("splitMemberFromCluster", Thrift.MessageType.EXCEPTION, seqid);
...
RemoteControllerProcessor.prototype.process_mergeMemberToCluster = function(seqid, input, output) {
  ...
  args.read(input);
  input.readMessageEnd();
  if (this._handler.mergeMemberToCluster.length === 3) {
    Q.fcall(this._handler.mergeMemberToCluster, args.clusterId, args.memberId, args.delay)
      .then(function(result) {
        var result = new RemoteController_mergeMemberToCluster_result({success: result});
    ...
    this._handler.mergeMemberToCluster(args.clusterId, args.memberId, args.delay, function (err, result) {
      if (err == null) {
        var result = new RemoteController_mergeMemberToCluster_result((err != null ? err : {success: result}));
        output.writeMessageBegin("mergeMemberToCluster", Thrift.MessageType.REPLY, seqid);
      } else {
        var result = new Thrift.TApplicationException(Thrift.TApplicationExceptionType.UNKNOWN, err.message);
        output.writeMessageBegin("mergeMemberToCluster", Thrift.MessageType.EXCEPTION, seqid);
...
RemoteControllerProcessor.prototype.process_executeOnController = function(seqid, input, output) {
  ...
  if (this._handler.executeOnController.length === 3) {
    Q.fcall(this._handler.executeOnController, args.clusterId, args.script, args.lang)
      .then(function(result) {
        var result = new RemoteController_executeOnController_result({success: result});
    ...
    this._handler.executeOnController(args.clusterId, args.script, args.lang, function (err, result) {
      if (err == null) {
        var result = new RemoteController_executeOnController_result((err != null ? err : {success: result}));
        output.writeMessageBegin("executeOnController", Thrift.MessageType.REPLY, seqid);
      } else {
        var result = new Thrift.TApplicationException(Thrift.TApplicationExceptionType.UNKNOWN, err.message);
        output.writeMessageBegin("executeOnController", Thrift.MessageType.EXCEPTION, seqid);
