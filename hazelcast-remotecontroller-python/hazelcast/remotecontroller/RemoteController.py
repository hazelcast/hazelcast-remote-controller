...
class Client(Iface):
  ...
  def startMember(self, clusterId, delay):
    ...
    Parameters:
     ...
     - delay
    """
    self.send_startMember(clusterId, delay)
    return self.recv_startMember()

  def send_startMember(self, clusterId, delay):
  ...
  def shutdownMember(self, clusterId, memberId, delay):
    ...
    Parameters:
     ...
     - delay
    """
    self.send_shutdownMember(clusterId, memberId, delay)
    return self.recv_shutdownMember()

  def send_shutdownMember(self, clusterId, memberId, delay):
  ...
  def terminateMember(self, clusterId, memberId, delay):
    ...
    Parameters:
     ...
     - delay
    """
    self.send_terminateMember(clusterId, memberId, delay)
    return self.recv_terminateMember()

  def send_terminateMember(self, clusterId, memberId, delay):
  ...
  def shutdownCluster(self, clusterId, delay):
    ...
    Parameters:
     ...
     - delay
    """
    self.send_shutdownCluster(clusterId, delay)
    return self.recv_shutdownCluster()

  def send_shutdownCluster(self, clusterId, delay):
  ...
  def terminateCluster(self, clusterId, delay):
    ...
    Parameters:
     ...
     - delay
    """
    self.send_terminateCluster(clusterId, delay)
    return self.recv_terminateCluster()

  def send_terminateCluster(self, clusterId, delay):
  ...
  def splitMemberFromCluster(self, memberId, delay):
    ...
    Parameters:
     ...
     - delay
    """
    self.send_splitMemberFromCluster(memberId, delay)
    return self.recv_splitMemberFromCluster()

  def send_splitMemberFromCluster(self, memberId, delay):
  ...
  def mergeMemberToCluster(self, clusterId, memberId, delay):
    ...
    Parameters:
     ...
     - delay
    """
    self.send_mergeMemberToCluster(clusterId, memberId, delay)
    return self.recv_mergeMemberToCluster()

  def send_mergeMemberToCluster(self, clusterId, memberId, delay):
...
class Processor(Iface, TProcessor):
  ...
  def process_startMember(self, seqid, iprot, oprot):
    ...
    result = startMember_result()
    try:
      result.success = self._handler.startMember(args.clusterId, args.delay)
      msg_type = TMessageType.REPLY
    except (TTransport.TTransportException, KeyboardInterrupt, SystemExit):
      raise
    except Exception as ex:
  ...
  def process_shutdownMember(self, seqid, iprot, oprot):
    ...
    result = shutdownMember_result()
    try:
      result.success = self._handler.shutdownMember(args.clusterId, args.memberId, args.delay)
      msg_type = TMessageType.REPLY
    except (TTransport.TTransportException, KeyboardInterrupt, SystemExit):
      raise
    except Exception as ex:
  ...
  def process_terminateMember(self, seqid, iprot, oprot):
    ...
    result = terminateMember_result()
    try:
      result.success = self._handler.terminateMember(args.clusterId, args.memberId, args.delay)
      msg_type = TMessageType.REPLY
    except (TTransport.TTransportException, KeyboardInterrupt, SystemExit):
      raise
    except Exception as ex:
  ...
  def process_shutdownCluster(self, seqid, iprot, oprot):
    ...
    result = shutdownCluster_result()
    try:
      result.success = self._handler.shutdownCluster(args.clusterId, args.delay)
      msg_type = TMessageType.REPLY
    except (TTransport.TTransportException, KeyboardInterrupt, SystemExit):
      raise
    except Exception as ex:
  ...
  def process_terminateCluster(self, seqid, iprot, oprot):
    ...
    result = terminateCluster_result()
    try:
      result.success = self._handler.terminateCluster(args.clusterId, args.delay)
      msg_type = TMessageType.REPLY
    except (TTransport.TTransportException, KeyboardInterrupt, SystemExit):
      raise
    except Exception as ex:
  ...
  def process_splitMemberFromCluster(self, seqid, iprot, oprot):
    ...
    result = splitMemberFromCluster_result()
    try:
      result.success = self._handler.splitMemberFromCluster(args.memberId, args.delay)
      msg_type = TMessageType.REPLY
    except (TTransport.TTransportException, KeyboardInterrupt, SystemExit):
      raise
    except Exception as ex:
  ...
  def process_mergeMemberToCluster(self, seqid, iprot, oprot):
    ...
    result = mergeMemberToCluster_result()
    try:
      result.success = self._handler.mergeMemberToCluster(args.clusterId, args.memberId, args.delay)
      msg_type = TMessageType.REPLY
    except (TTransport.TTransportException, KeyboardInterrupt, SystemExit):
      raise
    except Exception as ex:
...
class startMember_args(object):
  ...
  def __init__(self, clusterId=None, delay=None,):
...
class shutdownMember_args(object):
  ...
  thrift_spec = (
    None, # 0
    (1, TType.STRING, 'clusterId', None, None, ), # 1
    (2, TType.STRING, 'memberId', None, None, ), # 2
    (3, TType.I32, 'delay', None, None, ), # 3
  )

  def __init__(self, clusterId=None, memberId=None, delay=None,):
    self.clusterId = clusterId
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        ...
        if ftype == TType.STRING:
          self.memberId = iprot.readString().decode('utf-8')
        else:
          iprot.skip(ftype)
      elif fid == 3:
        if ftype == TType.I32:
  ...
  def write(self, oprot):
    ...
    if self.memberId is not None:
      ...
      oprot.writeString(self.memberId.encode('utf-8'))
      oprot.writeFieldEnd()
    if self.delay is not None:
      oprot.writeFieldBegin('delay', TType.I32, 3)
      oprot.writeI32(self.delay)
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
    oprot.writeStructEnd()
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.clusterId)
    value = (value * 31) ^ hash(self.memberId)
    value = (value * 31) ^ hash(self.delay)
    return value
...
class splitMemberFromCluster_args(object):
  ...
  def __init__(self, memberId=None, delay=None,):
    self.memberId = memberId
    self.delay = delay
